...
# # PROYECTO AP_Selection Adaptive Random Forests ARF 
# 
...
clasificador = AdaptiveRandomForest()
print(clasificador.get_info())

print("start training")
clasificador.fit(X_train,y_train, classes=None, sample_weight=None)
print("end training")
print("100%", clasificador.score(X100_test, y100_test), metrics.mean_absolute_error(y100_test, y100_pred),  metrics.mean_squared_error(y100_test, y100_pred), np.sqrt(metrics.mean_squared_error(y100_test, y100_pred)), accuracy_score(y100_test, y100_pred))
...
plt.suptitle('ARF', x = 0.5, y = 1.1, fontsize=18)   
f.tight_layout()
