...
# https://scikit-multiflow.github.io/scikit-multiflow/skmultiflow.classification.meta.adaptive_random_forests.html
...
clasificador = RandomForestClassifier(n_estimators=26, max_depth=20, random_state=0, oob_score=True)
print(clasificador)
...
# print("100%", clasificador1.score(X100_test, y100_test), metrics.mean_absolute_error(y100_test, y100_pred),  metrics.mean_squared_error(y100_test, y100_pred), np.sqrt(metrics.mean_squared_error(y100_test, y100_pred)), accuracy_score(y100_test, y100_pred))
...
plt.suptitle('RF', x = 0.5, y = 1.1, fontsize=18)   
f.tight_layout()
