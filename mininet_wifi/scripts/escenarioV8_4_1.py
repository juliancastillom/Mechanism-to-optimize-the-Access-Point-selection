...
#Se mueve unicamente la estacion 1
...
def myNetwork():
	...
	for data in raw_data:
		...
		for i in range( len(sta1.params["apsInRange"]) ):
			...
			f_ml.write("{},{},{},{},{},{},{},{},{}\n".format(str(sta1.name), str(aps), str(ap_temp.name), str(rssi_aptemp), str(n_est_aptemp), str(dis_to_aptemp),str(sta1.params['battery']), str(bat_temp), str(sta1.params['associatedTo'][0].name)))
