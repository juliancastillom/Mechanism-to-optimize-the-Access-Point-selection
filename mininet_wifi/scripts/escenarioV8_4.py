...
#Creado para probar algoritmo Random Forest
...
def myNetwork():
	...
	for data in raw_data:
		...
		f_sta_info.write('{},{},{},{},{}\n'.format( "sta11", str(int(round(time.time() * 1000))), line[1].split(",")[0], line[1].split(",")[1], line[1].split(",")[2] ) )
		f_sta_info.write('{},{},{},{},{}\n'.format( str(sta2.name), str(int(round(time.time() * 1000))), line[2].split(",")[0], line[2].split(",")[1], line[2].split(",")[2] ) )
		f_sta_info.write('{},{},{},{},{}\n'.format( str(sta3.name), str(int(round(time.time() * 1000))), line[3].split(",")[0], line[3].split(",")[1], line[3].split(",")[2] ) )
		f_sta_info.write('{},{},{},{},{}\n'.format( str(sta4.name), str(int(round(time.time() * 1000))), line[4].split(",")[0], line[4].split(",")[1], line[4].split(",")[2] ) )
		f_sta_info.write('{},{},{},{},{}\n'.format( str(sta5.name), str(int(round(time.time() * 1000))), line[5].split(",")[0], line[5].split(",")[1], line[5].split(",")[2] ) )
		f_sta_info.write('{},{},{},{},{}\n'.format( "sta55", str(int(round(time.time() * 1000))), line[5].split(",")[0], line[5].split(",")[1], line[5].split(",")[2] ) )
		...
		for i in range( len(sta2.params["apsInRange"]) ):
			...
			#f_sta1_data.write('{"time":"%s", "sta":"%s", "x":"%s", "y": "%s", "z":"%s", "ref":"%s", "distanceToRef":"%s"}\n' %(str(int(round(time.time() * 1000))),str(sta2.name), line[1].split(",")[0], line[1].split(",")[1], line[1].split(",")[2],sta2.params['associatedTo'][0].name, sta2.get_distance_to(sta2.params['associatedTo'][0])) )
		...
		for i in range( len(sta3.params["apsInRange"]) ):
			...
			for n in range( len(sta3.params["apsInRange"]) ):
				ap_temp2 = sta3.params['apsInRange'][n]
				aps = aps + ap_temp2.name
			...
			#f_sta1_data.write('{"time":"%s", "sta":"%s", "x":"%s", "y": "%s", "z":"%s", "ref":"%s", "distanceToRef":"%s"}\n' %(str(int(round(time.time() * 1000))),str(sta3.name), line[1].split(",")[0], line[1].split(",")[1], line[1].split(",")[2],sta3.params['associatedTo'][0].name, sta3.get_distance_to(sta3.params['associatedTo'][0])) )
		...
		for i in range( len(sta5.params["apsInRange"]) ):
			...
			#f_sta1_data.write('{"time":"%s", "sta":"%s", "x":"%s", "y": "%s", "z":"%s", "ref":"%s", "distanceToRef":"%s"}\n' %(str(int(round(time.time() * 1000))),str(sta5.name), line[1].split(",")[0], line[1].split(",")[1], line[1].split(",")[2],sta5.params['associatedTo'][0].name, sta5.get_distance_to(sta5.params['associatedTo'][0])) )
