#!/usr/bin/python
#ERRORES #Prueba -> se prueba el escenario para hacer la grafica en otro hilo y...
#...ver la posibilidad de graficar junto con la funcion replayingMobility
#Conclusion (revisar el archivo replay en la linea 36...
#... ver la posibilidad de enviar los parametros de la grafica de otra manera)
...
def myNetwork():
	...
	hilo = threading.Thread(name='grafica', target=grafica, args=(net, u1_d1, u1_d2, u1_d3, u2_d1, u2_d2, u2_d3, u2_d4, sta1, sta2))
	#hilo.daemon = True
	hilo.start()

def grafica(net, u1_d1, u1_d2, u1_d3, u2_d1, u2_d2, u2_d3, u2_d4, sta1, sta2):
