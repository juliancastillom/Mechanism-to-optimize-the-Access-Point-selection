...
def myNetwork():
	...
	ap1 = net.addAccessPoint('ap1', ssid='ap1-ssid', mode='ac', channel='1', position='50.0,150.0,0', range = 45)
	ap2 = net.addAccessPoint('ap2', ssid='ap2-ssid', mode='ac', channel='7', position='90.0,150.0,0', range = 30)
	ap3 = net.addAccessPoint('ap3', ssid='ap3-ssid', mode='ac', channel='11', position='130.0,150.0,0', range=45)
	ap4 = net.addAccessPoint('ap4', ssid='ap4-ssid', mode='ac', channel='11', position='50.0,90.0,0', range=40)
	s1 = net.addSwitch('s1')
