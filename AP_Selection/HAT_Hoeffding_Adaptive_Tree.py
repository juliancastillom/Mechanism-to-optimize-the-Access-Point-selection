...
# # PROYECTO AP_Selection HAT_Hoeffding_Adaptive_Tree
# 
# https://scikit-multiflow.github.io/scikit-multiflow/index.html
# 
# https://scikit-multiflow.github.io/scikit-multiflow/_autosummary/skmultiflow.trees.HAT.html#skmultiflow.trees.HAT
...
plt.suptitle('HAT', x = 0.5, y = 1.1, fontsize=18)   
f.tight_layout()
