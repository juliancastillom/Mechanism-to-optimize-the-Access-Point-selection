...
def myNetwork():
	...
	#f_sta_info.write('{},{},{},{},{}\n'.format("station", "associatedTo","time", "position", "x","y","z"))
	...
	for data in raw_data:
		...
		#f_sta1_info.write('{},{},{},{},{},{},{}\n'.format( str(sta1.name), str(sta1.params['associatedTo'][0].name), str(int(round(time.time() * 1000))), str(sta1.params['rssi']), line[1].split(",")[0], line[1].split(",")[1], line[1].split(",")[2] ) )
