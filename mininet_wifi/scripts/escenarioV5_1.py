#!/usr/bin/python
#Prueba -> se prueba el escenario con un movimiento lineal
...
def myNetwork():
	...
	hilo = threading.Thread(name='grafica', target=grafica, args=(net, u1_d1, u1_d2, u1_d3))
	#hilo.daemon = True
	hilo.start()
...
def grafica(net, u1_d1, u1_d2, u1_d3):
