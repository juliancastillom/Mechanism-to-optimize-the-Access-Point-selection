...
def myNetwork():
	...
	ap2 = net.addAccessPoint('ap2', ssid='ap2-ssid', mode='n', channel='7', position='90.0,150.0,0', antennaGain = 3, range = 30, battery = 100)# gain 3 = ( gain = 3)
	...
	u2_d1 = net.addStation('u2_d1', ip='10.0.0.4', mac='01:02:01:00:02:01', position='50.0,70.0,0', range = 20, speed = 2, battery = 100)
	u2_d2 = net.addStation('u2_d2', ip='10.0.0.5', mac='02:02:02:00:02:02', position='50.0,70.0,0', range = 20, speed = 2, battery = 100)
	u2_d3 = net.addStation('u2_d3', ip='10.0.0.6', mac='03:02:03:00:02:03', position='50.0,70.0,0', range = 20, speed = 2, battery = 100)
	u2_d4 = net.addStation('u2_d4', ip='10.0.0.7', mac='04:02:04:00:02:04', position='50.0,70.0,0', range = 20, speed = 2, battery = 100)
	...
	sta5 = net.addStation('sta5', ip='10.0.1.5', mac='00:00:00:00:09:05', position='160.0,125.0,0', range = 20, battery = 100)
	...
	net.mobility( sta1, 'stop', time=15, position= sta1_stop)
	...
	ap2.setTxPower(1, intf='ap2-wlan1')
