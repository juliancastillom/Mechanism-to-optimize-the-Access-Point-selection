#!/usr/bin/python
#creado 12_nov_2019
#creado para provar un moviento random_walk en el escenario
...
def myNetwork():
	...
	makeTerm( sta5, cmd="bash -c 'iperf -s -u -p 5566 -i 1 > resultiperf_sta1_rand_walk;'" )
	...
	file_mov = "rand_walk_sta1_steps_500.txt"
	#file_mov = "movimientos_entrenamientoV2.txt"
	mov1 = open(file_mov, 'r')
	raw_data = mov1.readlines()
	mov1.close()
	
	f_sta1_info= open("output/sta1_rand_walk_info.txt","w+")
