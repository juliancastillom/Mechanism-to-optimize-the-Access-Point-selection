...
def myNetwork():
	...
	mov1.close()
	#f= open("ssf_test_escenarioV6_1.txt","w+")
	for data in raw_data:
		...
		"""
		f.write("********************************************************" + "\n")
		f.write("Mov # " + str(line[0]) + "\n")
		f.write("Position: " + str(sta1.params['position']) + "\n")
		f.write("-----------------------" + "\n")
		f.write("AP1: " + str(ap1.params['stationsInRange']) + "\n")
		f.write("-----------------------" + "\n")
		f.write("AP2: " + str(ap2.params['stationsInRange']) + "\n")
		f.write("-----------------------" + "\n")
		f.write("AP3: " + str(ap3.params['stationsInRange']) + "\n")
		f.write("-----------------------" + "\n")
		f.write("RSSI Sta1: " + str(sta1.params['rssi']) + "\n")
		f.write("-----------------------" + "\n")
		f.write("Associated to: " + str(sta1.params['associatedTo']) + "\n")
		"""
		time.sleep(0.05)
	#f.close()
