...
def myNetwork():
	...
	#net = Mininet_wifi(link=TCLink, xterms=True )
	...
	print sta1.cmd('sta_output/touch sta1_file.txt') #Crear archivo automaticamene
	
	print('\n---- IoT device 2 ---- \n  ~~~~ Command to limit bandwidth ~~~~\n    .... wondershaper sta2-wlan0 1024 512 ....')
	print sta2.cmd('wondershaper sta2-wlan0 1024 512')
	print sta2.cmd('pwd')
	print sta2.cmd('sta_output/touch sta2_file.txt') #Crear archivo automaticamente
