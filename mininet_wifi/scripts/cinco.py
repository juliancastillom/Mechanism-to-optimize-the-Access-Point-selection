...
def topology():
	...
	sta3 = net.addStation('sta3', mac='00:00:00:00:00:04', ip='10.0.0.4/8', position='45,65,0',  range=20)
	...
	ap2 = net.addAccessPoint('ap2', ssid='ssid-ap2', mode='g', channel='4', position='60,70,0', range=15)  # range: set the AP range
	...
	*** Association Control (AC) - mechanism that optimizes the use of the APs:
	...
	#net.startMobility( time=0, model='RandomWayPoint' , min_x=10, max_x=20, min_y=10, max_y=20, constantDistance=1, constantVelocity=1, associationControl = 'ssf', seed = 1)
	net.startMobility(time=0, model='RandomWalk', max_x=120, max_y=110, min_v=10, max_v=15, associationControl = 'ssf', seed = 1 )
