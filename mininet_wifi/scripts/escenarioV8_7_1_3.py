#!/usr/bin/python
#creado 12_nov_2019
#creado para provar un moviento random_walk_2 en el escenario
...
def myNetwork():
	...
	sta1 = net.addStation('sta1', ip='10.0.1.123', mac='00:00:00:00:09:01', position='88.5,146.2,0.0', range = 20, speed = 5, battery = 100, hist = [[0, 0, 0],[0, 0, 0],["","",""],["","","","","","","","","","","","","",""]])
	...
	makeTerm( sta5, cmd="bash -c 'iperf -s -u -p 5566 -i 1 > resultiperf_sta1_rand_walk_2;'" )
	...
	file_mov = "rand_walk_2_sta1_steps_500.txt"
	#file_mov = "movimientos_entrenamientoV2.txt"
	mov1 = open(file_mov, 'r')
	raw_data = mov1.readlines()
	mov1.close()
	
	f_sta1_info= open("output/sta1_rand_walk_2_info.txt","w+")
	...
	for data in raw_data:
		line = data.split()
		#sta1.setPosition_group("{}".format(line[1]), net)
