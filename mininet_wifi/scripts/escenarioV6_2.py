	...
	def myNetwork():
		...
		print sta1.cmd('touch sta1_file.txt') #Crear archivo automaticamene
		
		print('\n---- IoT device 2 ---- \n  ~~~~ Command to limit bandwidth ~~~~\n    .... wondershaper sta2-wlan0 1024 512 ....')
		print sta2.cmd('wondershaper sta2-wlan0 1024 512')
		print sta2.cmd('pwd')
		print sta2.cmd('touch sta2_file.txt') #Crear archivo automaticamente
		#print sta2.cmd('python aleat.py')
		#print sta2.cmd('python aleat.py &')
		
		#print sta2.cmd('curl -o imagen2.png  https://salmorejogeek.files.wordpress.com/2016/04/ubuntu_logo.png ')
		...
		for data in raw_data:
			...
			f_sta1.write("********************************************************" + "\n")
			f_sta1.write( time.strftime("%H:%M:%S") + "\n")
			f_sta1.write("Mov # " + str(line[0]) + "\n")
			f_sta1.write("AP in range: " + str(sta1.params['apsInRange']) + "\n")
			f_sta1.write("Associated to: " + str(sta1.params['associatedTo']) + "\n")
			f_sta1.write("RSSI Sta1: " + str(sta1.params['rssi']) + "\n")
			f_sta1.write("Position: " + str(sta1.params['position']) + "\n")
			f_sta1.write("MAC: " + str(sta1.params['mac']) + "\n")
			f_sta1.write("-----------------------" + "\n")
			
			f_ap1.write("********************************************************" + "\n")
			f_ap1.write( time.strftime("%H:%M:%S") + "\n")
			f_ap1.write("Mov # " + str(line[0]) + "\n")
			f_ap1.write("Stations in range: " + str(ap1.params['stationsInRange']) + "\n")
			f_ap1.write("Associated Stations: " + str(ap1.params['associatedStations']) + "\n")
			f_ap1.write("MAC: " + str(ap1.params['mac']) + "\n")
			f_ap1.write("Position: " + str(ap1.params['position']) + "\n")
			f_ap1.write("Range: " + str(ap1.params['range']) + "\n")
			f_ap1.write("Channel: " + str(ap1.params['channel']) + "\n")
			f_ap1.write("Freq: " + str(ap1.params['freq']) + "\n")
			f_ap1.write("Antenna Gain: " + str(ap1.params['antennaGain']) + "\n")
			
			f_ap2.write("********************************************************" + "\n")
			f_ap2.write( time.strftime("%H:%M:%S") + "\n")
			f_ap2.write("Mov # " + str(line[0]) + "\n")
			f_ap2.write("Stations in range: " + str(ap2.params['stationsInRange']) + "\n")
			f_ap2.write("Associated Stations: " + str(ap2.params['associatedStations']) + "\n")
			f_ap2.write("MAC: " + str(ap2.params['mac']) + "\n")
			f_ap2.write("Position: " + str(ap2.params['position']) + "\n")
			f_ap2.write("Range: " + str(ap2.params['range']) + "\n")
			f_ap2.write("Channel: " + str(ap2.params['channel']) + "\n")
			f_ap2.write("Freq: " + str(ap2.params['freq']) + "\n")
			f_ap2.write("Antenna Gain: " + str(ap2.params['antennaGain']) + "\n")
			
			f_ap3.write("********************************************************" + "\n")
			f_ap3.write( time.strftime("%H:%M:%S") + "\n")
			f_ap3.write("Mov # " + str(line[0]) + "\n")
			f_ap3.write("Stations in range: " + str(ap3.params['stationsInRange']) + "\n")
			f_ap3.write("Associated Stations: " + str(ap3.params['associatedStations']) + "\n")
			f_ap3.write("MAC: " + str(ap3.params['mac']) + "\n")
			f_ap3.write("Position: " + str(ap3.params['position']) + "\n")
			f_ap3.write("Range: " + str(ap3.params['range']) + "\n")
			f_ap3.write("Channel: " + str(ap3.params['channel']) + "\n")
			f_ap3.write("Freq: " + str(ap3.params['freq']) + "\n")
			f_ap3.write("Antenna Gain: " + str(ap3.params['antennaGain']) + "\n")
			
			f_ap4.write("********************************************************" + "\n")
			f_ap4.write( time.strftime("%H:%M:%S") + "\n")
			f_ap4.write("Mov # " + str(line[0]) + "\n")
			f_ap4.write("Stations in range: " + str(ap4.params['stationsInRange']) + "\n")
			f_ap4.write("Associated Stations: " + str(ap4.params['associatedStations']) + "\n")
			f_ap4.write("MAC: " + str(ap4.params['mac']) + "\n")
			f_ap4.write("Position: " + str(ap4.params['position']) + "\n")
			f_ap4.write("Range: " + str(ap4.params['range']) + "\n")
			f_ap4.write("Channel: " + str(ap4.params['channel']) + "\n")
			f_ap4.write("Freq: " + str(ap4.params['freq']) + "\n")
			f_ap4.write("Antenna Gain: " + str(ap4.params['antennaGain']) + "\n")
